package IS-Project.comedor-ucv.src.main.Vista;
...
public class BienvenidoVista extends JFrame {
    ...
    private final Color COLOR_GO = new Color(200, 200, 200); // Gris oscurito
    ...
    //Botones del menu
    private JButton btnConsultarMenu, btnDashboard, btnSistemaGestion, btnHistorial, btnPerfil;
    ...
    public BienvenidoVista(String usuario, String rol) {
        ...
        btnSistemaGestion = crearBotonMenu("Sistema de Gestion"); 
        sidebar.add(btnSistemaGestion);
        sidebar.add(Box.createRigidArea(new Dimension(0, 10)));
        ...
        mainContainer.add(dashboardPanel, "dashVista");
        mainContainer.add(historialPanel, "histVista");

        MenuPanel menuPanel = new MenuPanel();
        mainContainer.add(menuPanel, "menuDiaVista");
